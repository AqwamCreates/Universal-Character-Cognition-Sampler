...
* Everyday Human Manipulation Hidden Inside Training Data
  ...
  * PS: Profoundly Disturbing For My "Sociopath" Brain. I Thought It Would Not Be That Common. Every Character I Tried (Including Psychologists, Counselors, Journalists And Police Officers) Have Some Sort Of Manipulative Aspects In Their Character Configurations.
...
| Model Name                                 | Model Parameter Size | Quantization | Description                                                                                         |
|--------------------------------------------|----------------------|--------------|-----------------------------------------------------------------------------------------------------|
| DarkIdol Llama-3.1 Instruct 1.2 Uncensored | 8B                   | IQ2_M        | Rivals With Q3_K_L With High Speed; Requires Some Refreshes Due To Roleplay Leakage And Repetitions |
